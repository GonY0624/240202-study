...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   비교연산자
        *   비교연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참 혹은 가짓을 반환하는 연산자이다.
        ...
        *    */
        ...
        System.out.println("inum1이 inum2 보다 크거나 같은지 비교: " +( inum1 >= inum2 ));
        System.out.println("inum1이 inum2 보다 작은지 비교: " +( inum1 < inum2 ));
        System.out.println("inum1이 inum2 보다 적거나 같은지 비교: " +( inum1 <= inum2 ));
        ...
        System.out.println("ch1과 ch2가 같은지 않은지 비교: " +( ch1 != ch2 ));
        System.out.println("ch1이 ch2 보다 큰 지 비교: " +( ch1 > ch2 ));
        System.out.println("ch1이 ch2 보다 크거나 같은지 비교: " +( ch1 >= ch2 ));
        System.out.println("ch1이 ch2 보다 작은지 비교: " +( ch1 < ch2 ));
        System.out.println("ch1이 ch2 보다 적거나 같은지 비교: " +( ch1 <= ch2 ));
        ...
        System.out.println("bool1 과 bool2가 같은지 비교: " +( bool1== bool2 ));
        System.out.println("bool1과 bool2가 같은지 않은지 비교: " +( bool1 != bool2 ));
        System.out.println("=============================================");
//        System.out.println("bool1이 bool2 보다 큰 지 비교: " +( bool1 > bool2 ));
//        System.out.println("bool1이 bool2 보다 크거나 같은지 비교: " +( bool1 >= bool2 ));
//        System.out.println("bool1이 bool2 보다 작은지 비교: " +( bool1 < bool2 ));
//        System.out.println("bool1이 bool2 보다 적거나 같은지 비교: " +( bool1 <= bool2 ));
        ...
        System.out.println("str1과 str2가 같은지 않은지 비교: " +( str1 != str2 ));
        System.out.println("==============================================");
//        System.out.println("str1이 str2 다른지 비교: " +( str1 > str2 ));
//        System.out.println("str1이 str2 다른지 비교: " +( str1 >= str2 ));
//        System.out.println("str1이 str2 다른지 비교: " +( str1 < str2 ));
//        System.out.println("str1이 str2 다른지 비교: " +( str1 <= str2 ));
