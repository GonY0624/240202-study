...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   AND 연산과 OR연산의 특징
        *   논리식 && 논리식 : 앞의 결과가 false 이면 귀를 실행 안함.
        ...
        *  */
        ...
        int result1=( false && ++num1 > 0) ? num1 : num1; // &&연산자는 앞이 false면 뒤를 생각하지 않는다.

        System.out.println("&&실행확인: " +result1);

        /* 목차. 2. 논리식 || 논리식 : 앞의 결과가 true이면 뒤를 실행하지 않는다.  */
        /* 필기.
        *   조건식 둘 중 하나라고 true 를 반환하면 true 를 반환하기 때문에 앞에서 미리 true가
        ...
        * */
        ...
        int result2=(false || ++num2 >0)?num2:num2; //||연산자는 앞이 true이면 뒤를 생각하지 않는다.
