...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   논리 연산자의 운선순위와 활용
        *   논리 & 연산자와 논리 | 연산자의 운선순위
        *   && : 11순위
        *   || : 12순위
        *   논리 && 연산자의 운선수위가 논리 || 연산자의 우선순위보다 높다.
        *  */

        /* 목차. 1. 1부터 100 사이의 값인지 확인 */
        int num1=55;
        System.out.println("1 부터 100사이인지 확인: " +(num1>=1&&num1<=100));

        int num2=166;
        System.out.println("1 부터 100사이인지 확인: " +(num2>=1&&num2<=100));
